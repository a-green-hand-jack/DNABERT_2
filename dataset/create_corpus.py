...
def cli(input_file, contigs_split_file, output_dir, io_mode, min_len):
    ...
    # 创建 ThreadPoolExecutor 对象，指定线程池中的线程数量
    with concurrent.futures.ThreadPoolExecutor() as executor:
        # 提交第一个函数调用给线程池，并返回 Future 对象
...
if __name__ == "__main__":
    ...
    """
    在这里给出一个实例：
    python create_corpus.py --input-file "../../Datasets/Human_genome/huixin/GRCh38.p14.genome.fa.gz" --output-dir "../../Datasets/Human_genome/huixin/create_corpus"      
    """
    cli()
